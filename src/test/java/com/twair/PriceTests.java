...
public class PriceTests {
    ...
    public void shouldGiveTotalPriceForNumberOfSeats() throws Exception {
        ...
        TravelClass travelClass = new TravelClass(ClassType.ECONOMY,5,6000.0);
        when(flight.getTravelClass(ClassType.ECONOMY)).thenReturn(travelClass);
        Double totalCost = price.calculate(flight.getTravelClass(ClassType.ECONOMY), numberOfSeats);
